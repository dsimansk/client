...
```
      ...
      --containers string             Specify path to file containing definition for additional containers, alternatively use '-' to read from stdin. Example: --containers ./containers.yaml or --containers -.
...
* [kn container](kn_container.md)	 - Manage containers
